...
wt            <button class="share-btn${item.shared ? ' shared-active' : ''}" aria-label="${item.shared ? 'Disable' : 'Enable'} sharing for item" title="${item.shared ? 'Sharing enabled' : 'Enable sharing'}"></button>
